/**
 * Created by Sreerama on 8/31/2015.
 */
...
public class CircularlyLinkedListTest {
    ...
    public void testAddToFront() {
        //if size == 0
        list.addToFront(84); //linked list: 84
        ...
        //if size == 1
        list.addToFront(12); //linked list: 12, 84
        ...
        //if size > 1
        list.addToFront(95); //linked list: 95, 12, 84
    ...
    public void testAddToBack() {
        //if size == 0
        list.addToBack(84); //linked list: 84
        assertEquals(1, list.size());
        LinkedListNode<Integer> node = list.getHead();
        assertNotNull(node);
        assertNotNull(node.getPrevious());
        ...
        assertEquals((Integer) 84, node.getNext().getData());
        //if size == 1
        list.addToBack(12); //linked list: 84, 12
        assertEquals(2, list.size());
        node = list.getHead();
        assertNotNull(node);
        assertNotNull(node.getPrevious());
        ...
        //if size >= 2
        list.addToBack(95); //linked list: 84, 12, 95
        assertEquals(3, list.size());
        node = list.getHead();
        assertNotNull(node);
        assertNotNull(node.getPrevious());
        ...
        list.addToBack(48); //linked list: 84, 12, 95, 48
        ...
        assertEquals((Integer) 48, node.getNext().getNext().getNext().getData());
    }
    ...
    public void testRemoveBack() {
        ...
        node = list.getHead();
        LinkedListNode<Integer> tail = node.getPrevious();

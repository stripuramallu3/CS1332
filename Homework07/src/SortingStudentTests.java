...
public class SortingStudentTests {
    ...
    public void setUp() {
        ...
        TeachingAssistant.comparisons = 0;
    }


    @Test(timeout = TIMEOUT)
    public void testCocktailShakerSort() {
        Sorting.cocktailShakerSort(tas, TeachingAssistant.getNameComparator());
        assertArrayEquals(tasByName, tas);
        assertTrue("Number of comparisons: " + TeachingAssistant.comparisons,
                TeachingAssistant.comparisons <= 45);
    }

    @Test(timeout = TIMEOUT)
    public void testInsertionSort() {
        Sorting.insertionSort(tas, TeachingAssistant.getNameComparator());
        assertArrayEquals(tasByName, tas);
        assertTrue("Number of comparisons: " + TeachingAssistant.comparisons,
                TeachingAssistant.comparisons <= 30);
    }

    @Test(timeout = TIMEOUT)
    public void testSelectionSort() {
        Sorting.selectionSort(tas, TeachingAssistant.getNameComparator());
    ...
    public void testQuickSort() {
        Sorting.quickSort(tas, TeachingAssistant.getNameComparator(),
    ...
    public void testMergeSort() {
        Sorting.mergeSort(tas, TeachingAssistant.getNameComparator());
        assertArrayEquals(tasByName, tas);
        assertTrue("Number of comparisons: " + TeachingAssistant.comparisons,
                TeachingAssistant.comparisons <= 48);
    }
    ...
    private static class TeachingAssistant {
         ...
         */
        public static Comparator<TeachingAssistant> getNameComparator() {
            return new Comparator<TeachingAssistant>() {
                @Override
         ...
         */
        public static Comparator<TeachingAssistant> getAgeComparator() {
            return new Comparator<TeachingAssistant>() {
                @Override
                public int compare(TeachingAssistant ta1,
                        TeachingAssistant ta2) {
         ...
         * assistants
         */
        public static Comparator<TeachingAssistant> getYearComparator() {
            return new Comparator<TeachingAssistant>() {
                @Override
                public int compare(TeachingAssistant ta1,
                        TeachingAssistant ta2) {

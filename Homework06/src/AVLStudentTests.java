...
public class AVLStudentTests {
    ...
    public void testHeightDepth() {
        ...
        assertEquals(1, avlTree.depth(new Integer(646)));
        assertEquals(3, avlTree.depth(new Integer(526)));
    }
    ...
    public void testDepthNotExists() {
        avlTree.add(646);
        avlTree.add(386);
        avlTree.add(856);
        avlTree.add(526);
